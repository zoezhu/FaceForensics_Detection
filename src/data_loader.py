...
class ImagesDataset(Dataset):
    def __init__(self, video_dirs, name, target, max_images_per_video, max_videos, transform, window_size, ratio=1.):
        self.name = name
        ...
        self._read_images(video_dirs, name, ratio)
...
def read_train_test_val_dataset(
        dataset_dir, name, target, splits_path, train_transform, val_transform, ratio=1., **dataset_kwargs
):
...
def read_dataset(
    ...
    for data_class_dir in data_class_dirs:
        ...
        # print("data_class_dir_path: ", data_class_dir_path)
